...
sudo apk add bat carapace eza fastfetch fd ffmpeg fzf delta dust lazygit go git-lfs imagemagick neovim nodejs npm ripgrep ruby starship tmux xclip zoxide
git lfs install
